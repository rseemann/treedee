...
//f0.add(params, 'iterations').min(1).max(8).step(1);
//f0.add(params, 'angle').min(0.0).max(180.0).step(1.0);
//f0.add(params, 'theta').min(0.0).max(180.0).step(1.0);
///f0.add(params, 'thetaRandomness').min(0.0).max(100.0).step(1.0);
//f0.add(params, 'scale').min(1.0).max(20.0).step(1.0);
//f0.add(params, 'scaleRandomness').min(0.0).max(100.0).step(1.0);
//f0.add(params, 'constantWidth').name("Constant width");

//var f1 = gui.addFolder('Colors');
//var aa = f1.addColor(colors, "background");
//f1.addColor(colors, 'general').name("Plants");
//var bb=f1.add(colors, 'random');
//f1.add(colors, 'alpha').min(0.0).max(1.0).step(0.1);
//aa.onChange(function(value)  {SetBackColor(value);});
//var f2 = gui.addFolder('Rules');
//f2.add(rules, 'axiom');
//f2.add(rules, 'mainRule').name('Main rule');
//f2.add(rules, 'Rule2').name('Rule 2');
...
//var screenshot = { screenshot: function(){
        //Canvas2Image.saveAsPNG(c); }};

//gui.add(clear, 'clear').name('Clean Up');
//gui.add(screenshot, 'screenshot').name('Screenshot');
  ...
  var vector_delta = new THREE.Vector3(scale, scale, 0);
    ...
    for (var j=0; j<n; j++){
        ...
        if (a == "F"){
          ...
          //endpoint.add(vector_delta);
          //var vector_delta1 = new THREE.Vector3().subVectors(endpoint, startpoint);
          ...
          //axis_delta = new THREE.Vector3().subVectors(startpoint, prev_startpoint).normalize();
        ...
        if (a == "%"){
          //var ax = new THREE.Vector3(5,30,0);
          //var rotaxis = new THREE.Vector3(ax.normalize());
          //endpoint.applyAxisAngle(ax.normalize(), rota * Math.PI / 180);
          //rota += deltarota;
...
//      f0.__controllers[i].updateDisplay();}
